...
function Notes() {
  ...
  return (
    <div className="flex flex-wrap justify-center mt-5">
      {status === "loading" && <div className="relative p-5 bg-yellow-800  w-64 h-64 m-5 shadow-2xl overflow-hidden">Loading...</div>}
      {status === "failed" && <div className="relative p-5 bg-yellow-700 w-64 h-64 m-5 shadow-2xl overflow-hidden">Sorry, {error}</div>}
      {notes.map((note) =>  (
        <div
        ...
        >
          <div className="p-5">
            ...
            <div className="absolute bg-white w-16 h-16 rotate-30   -top-6 -left-6" />
